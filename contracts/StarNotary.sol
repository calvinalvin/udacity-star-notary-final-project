...
contract StarNotary is ERC721 {
  ...
  string public name = "Calvin's Star Notary";
  ...
  function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
    ...
    require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender, "You must be the owner of the token you want to transfer"); 
